...
class Monster
  ...
  property :id, Serial
  property :pkm, Object
  property :extra, Object, :default => open("./extra").read.force_encoding('UTF-8')
  ...
  def blobe
    ...
    #return "#{self.encrypt}#{self.extra}".force_encoding('UTF-8')
  end
  ...
  def encrypt
   ...
   return shuffled.pack("LS*").force_encoding('UTF-8')
  end
